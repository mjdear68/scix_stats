...
The following plots use the well-known Iris data set that is frequently used for demonstration purposes. The data set contains measurements of flower parts for three species of Iris.
