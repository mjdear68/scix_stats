...
p1 <- iris %>% 
  ggplot(aes(x = Sepal.Length, y = Sepal.Width)) +
  geom_point() +
  labs(title = "Ungrouped", x = "Sepal Length", y = "Sepal Width") 

p2 <- iris %>% 
  ggplot(aes(x = Sepal.Length, y = Sepal.Width, colour = Species)) +
  geom_point() +
  labs(title = "Grouped By Species", x = "Sepal Length", y = "Sepal Width") 
...
iris %>% 
  ...
  geom_point() +
  labs(title = "Points Plot of Sepal Length For Each Species", x = "Species", y = "Sepal Length") 
```
