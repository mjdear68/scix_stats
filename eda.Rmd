...
* Quartiles - the scores that break the data into quarters
 - Q1 25%
 - Q2 50% (Median)
 - Q3 75%
...
This plot is similar to a scatter plot, except that the x-variable is qualitative. This plot shows the distribution of each variable within each group of the qualitative variable.
...
Overlaying the data points onto boxplots can provide useful additoinal information about the distribution of the data.
...
## Your Project : EDA On Dummy Data Set

Complete exploratory data analysis on your dummy data set. The objective is to see if your experiment can produce the expected results, and to produce examples of plots and tables that you plan to include in your report.
