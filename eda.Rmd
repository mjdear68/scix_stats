...
The previous table is an example of an appropriate way to format tables for scientific reports. See the [APA tables webpage](https://apastyle.apa.org/style-grammar-guidelines/tables-figures/tables) for further details and examples.
