...
\caption{\label{tab:unnamed-chunk-5}Summary Statistics}
\centering
\begin{tabular}[t]{llllllllll}
\toprule
Variable & notNA & NA & Mean & SD & Min & Q1 & Q2 (Median) & Q3 & Max\\
...
The previous two tables are examples of tables formatted appropriately for scientific reports. See the \href{https://apastyle.apa.org/style-grammar-guidelines/tables-figures/tables}{APA tables webpage} for further details and examples.
\end{quote}
...
\pandocbounded{\includegraphics[keepaspectratio]{statistics_for_science_extension_files/figure-latex/unnamed-chunk-13-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{statistics_for_science_extension_files/figure-latex/unnamed-chunk-14-1.pdf}} \pandocbounded{\includegraphics[keepaspectratio]{statistics_for_science_extension_files/figure-latex/unnamed-chunk-14-2.pdf}}
