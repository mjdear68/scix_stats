...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{./resources/img/types_of_data.png}}
...
The output above shows that the Iris data set has five variables, four that are continuous \emph{()} and one that is qualitative \emph{()}. There are 150 records (rows) in the data set.
...
\bottomrule\noalign{}
\endlastfoot
Boxplot & One quantitative variable; one grouping variable & Spread within each group \\
Histogram & One continuous variable & Identifying the population distribution \\
Scatter Plot & Two continuous variables & Identifying relationships between variables e.g.~linear, non-linear \\
...
\pandocbounded{\includegraphics[keepaspectratio]{statistics_for_science_extension_files/figure-latex/unnamed-chunk-7-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{statistics_for_science_extension_files/figure-latex/unnamed-chunk-8-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{statistics_for_science_extension_files/figure-latex/unnamed-chunk-9-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{statistics_for_science_extension_files/figure-latex/unnamed-chunk-10-1.pdf}}

Overlaying the data points onto boxplots can provide useful additional information about the spread of the data.

\pandocbounded{\includegraphics[keepaspectratio]{statistics_for_science_extension_files/figure-latex/unnamed-chunk-11-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{statistics_for_science_extension_files/figure-latex/unnamed-chunk-12-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{statistics_for_science_extension_files/figure-latex/unnamed-chunk-13-1.pdf}} \pandocbounded{\includegraphics[keepaspectratio]{statistics_for_science_extension_files/figure-latex/unnamed-chunk-13-2.pdf}}
