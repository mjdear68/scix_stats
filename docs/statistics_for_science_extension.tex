...
\tightlist
\item
  Describe the relationship between Sepal Length and Sepal Width for each species.
\item
  Draw a line of fit onto each plot. Use this line to estimate the Sepal Width for a Sepal Length of 6.5 for each species.
\end{enumerate}
