...
# (PART\*) Part 1: Statistical Concepts {-} 
...
## Extension - Spreadsheets and Statistical Computing Languages
...
> *Qualitative* data is often described as a *grouping variable* e.g. the participants in a medical trial are grouped by the treatment they are given.
...
The following is a summary of descriptive statistics for each quantitative variable in the Iris data set.
\begin{table}

\caption{(\#tab:unnamed-chunk-4)Summary Statistics}
\centering
...
It is also worthwhile creating a summary for each group in data sets with grouping variables. 
\begin{table}

\caption{(\#tab:unnamed-chunk-5)Summary Statistics}
\centering
\begin{tabular}[t]{llllllllll}
\toprule
Variable & notNA & NA & Mean & SD & Min & Q1 & Q2 (Median) & Q3 & Max\\
...
The previous two tables are examples of tables formatted appropriately for scientific reports. See the [APA tables webpage](https://apastyle.apa.org/style-grammar-guidelines/tables-figures/tables) for further details and examples.
...
![](statistics_for_science_extension_files/figure-latex/unnamed-chunk-6-1.pdf)<!-- --> 
...
![](statistics_for_science_extension_files/figure-latex/unnamed-chunk-7-1.pdf)<!-- --> 
...
![](statistics_for_science_extension_files/figure-latex/unnamed-chunk-8-1.pdf)<!-- --> 
...
![](statistics_for_science_extension_files/figure-latex/unnamed-chunk-9-1.pdf)<!-- --> 
...
![](statistics_for_science_extension_files/figure-latex/unnamed-chunk-10-1.pdf)<!-- --> 
...
![](statistics_for_science_extension_files/figure-latex/unnamed-chunk-11-1.pdf)<!-- --> 


Overlaying the data points onto boxplots can provide useful additional information about the spread of the data.

![](statistics_for_science_extension_files/figure-latex/unnamed-chunk-12-1.pdf)<!-- --> 
...
![](statistics_for_science_extension_files/figure-latex/unnamed-chunk-13-1.pdf)<!-- --> 
...
![](statistics_for_science_extension_files/figure-latex/unnamed-chunk-14-1.pdf)<!-- --> ![](statistics_for_science_extension_files/figure-latex/unnamed-chunk-14-2.pdf)<!-- --> 
...
<!--chapter:end:stat_tests.Rmd-->

# Further Reading {#further_reading}

## Books

[**Advanced High School Statistics 3rd Ed, Diez et al**](https://www.openintro.org/book/ahss/): A detailed and rigorous introduction to statistics that would suit advanced high school and undergraduate university students. The theory and applications of statistics are covered from collecting data through to inference and statistical tests. The book contains numerous exercise and examples to help students develop their knowledge and skills.
...
<!--chapter:end:further_reading.Rmd-->
